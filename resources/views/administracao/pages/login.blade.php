...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('assets/administracao/img/favicon/favicon.ico')}}" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('assets/administracao/vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  <span class="app-brand-logo">
                    <img  style="width: 20%;height: 20%;" src="{{asset('assets/administracao/logo.jpg')}}"  alt="" srcset="">
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bem-vindo ! 👋</h4>
              <p class="mb-4">Porfavor inicie sessão</p>
              ...
              <form  action="{{route('login.authenticate')}}" id="formAuthentication" class="mb-3" method="POST">
                @csrf
                <div class="mb-3">
                  ...
                  <input
                    ...
                    id="email"
                    name="email"
                    placeholder="Insira os seu email"
                    autofocus
                  />
                </div>
                ...
                <div class="mb-3">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="remember-me"> Lembre-se de mina</label>
                  </div>
                </div>
                <div class="mb-3">
