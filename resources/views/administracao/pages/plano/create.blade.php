...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Plano /</span> Publicar novo</h4>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input name="alvo" type="text" class="form-control @error('alvo') is-invalid @enderror" id="basic-default-fullname" placeholder="" />
                        @error('alvo')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                      </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input name="preco" type="text" class="form-control @error('preco') is-invalid @enderror" id="basic-default-fullname" placeholder="" />
                        @error('preco')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                      </div>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input name="moeda" type="text" class="form-control @error('moeda') is-invalid @enderror" id="basic-default-fullname" placeholder="" />
                        @error('moeda')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                      </div>
